...
predict_both_models=True #True if you want to use both m1 and m2 in the range
# that they are both valid.

predict_for_test=False #True if you want to use the models to predict for the
#test set. It is useful for testing purposes.

#load point samples
df_merged_2=pd.read_csv("/opt/models/model_static_files/cv/sun_test_set.csv")

#outfile
makecsvname=('/mnt/data/output/unique_name.csv')#
...
dataframe_array=df_merged_2.to_numpy()
...
data_input=df_merged_2[input_cols]
...
data_output=df_merged_2[output_cols]
...
data_coords=df_merged_2[coords_cols]
